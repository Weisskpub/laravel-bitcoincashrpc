...
namespace Weisskpub\Bitcoincash\Providers;

use Weisskpub\Bitcoincash\Client as BitcoincashClient;
...
class ServiceProvider extends IlluminateServiceProvider
{
    ...
    {
        $aliases = [
            'bitcoincashd' => 'Weisskrub\Bitcoincash\Client',
        ];
    ...
    protected function registerClient()
    {
        $this->app->singleton('bitcoincashd', function ($app) {
            return new BitcoincashClient([
                ...
                'port'   => $app['config']->get('bitcoincashd.port', 8335),
